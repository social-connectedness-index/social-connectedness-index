...
`precompute` builds a merge tree for each single country and each regional grouping
...
running the O(n³) clustering live. It is resumable and idempotent — re-run it after
